    ...
    <section className="" id="прайс-лист">
        ...
        >
          ...
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 ">
            {services.map((service) => (
              <Card key={service.id} className="  bg-[url('/wood.png')] text-white border-black  ">
      ...
      <div className="md:pl-[-300px]">
          ...
          <div className=" lg:1 lg:top 1 h-fit " >
            <Card className="bg-[url('/wood.png')] border-black">
              <CardContent className="p-1 md:p-1">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    після того як замовили через +- 10 хвилин я напишу вам в діскорд де можна забрати сет
                  <div>
                  ...
                  <p className="text-xs md:text-sm text-center text-white text-white">
